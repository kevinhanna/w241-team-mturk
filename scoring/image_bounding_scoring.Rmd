...
get_result_data <- function() {
  control <- fread("../data/Batch_3846852_batch_results_reg.csv")
  control[, in_treatment := 0]
  
  treatment <- fread("../data/Batch_3846847_batch_results_gov.csv")
...
```{r}
fwrite(formatted_mturk_image_boundings_dt, "../data/pilot1_results.csv")
```
