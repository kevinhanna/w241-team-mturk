...
```
    ...
    ##    in_treatment bounding_box_score log_bounding_box_score
    ## 1:            0           22.61808               3.118750
    ## 2:            0           14.08984               2.645454
    ## 3:            0           18.94323               2.941447
    ## 4:            0           16.76657               2.819387
    ## 5:            0           13.13188               2.575043
    ## 6:            0           25.11612               3.223510
...
```
    ...
    ##  -36.63  -21.64  -12.22    2.20 1167.20 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)    38.940      4.435   8.780   <2e-16 ***
    ## in_treatment   -4.101      6.272  -0.654    0.513    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 82.14 on 684 degrees of freedom
    ## Multiple R-squared:  0.0006247,  Adjusted R-squared:  -0.0008364 
    ## F-statistic: 0.4276 on 1 and 684 DF,  p-value: 0.5134
...
```
    ...
    ## t = -0.65388, df = 624.31, p-value = 0.5134
...
```
    ...
    ## Residuals:
    ##    Min     1Q Median     3Q    Max 
    ## -44.06 -27.68 -17.73  -2.29 502.41 
    ## 
    ## Coefficients:
    ##              Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)     37.98      10.97   3.462 0.000913 ***
    ## in_treatment    11.09      16.83   0.659 0.512297    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 71.1 on 71 degrees of freedom
    ## Multiple R-squared:  0.006072,   Adjusted R-squared:  -0.007927 
    ## F-statistic: 0.4337 on 1 and 71 DF,  p-value: 0.5123
