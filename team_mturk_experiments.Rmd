...
mean_d <- d6[, .(euclidean_score=mean(euclidean_score), iou_score=mean(iou_score), iou_score_filt=mean(iou_score_filt), euclidean_score_filt=mean(euclidean_score_filt)), keyby=.(WorkerId, Treat,Survey_Q1,Survey_Q2)]
