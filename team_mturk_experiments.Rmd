...
format_table(d[order(experiment_no), .("Mean Score"=mean(bounding_box_score, na.rm=T), 
...
```{r plot_experiment_1, echo=FALSE, fig.height=5, fig.width=10, fig.show='hold'}
...
```{r plot_experiment_2, echo=FALSE, fig.height=5, fig.width=10}
...
format_table(summary(d[experiment_no==2, .(bounding_box_score)]))
```

```{r experiment_2_summary_groups, echo=FALSE}

format_table(d[experiment_no==2, .(mean_score=mean(bounding_box_score, na.rm=T), std_dev=sd(bounding_box_score, na.rm=T)), keyby=.(in_treatment)])
```
...
#e2_mod_4 <- d[experiment_no==2, lm(bounding_box_score ~ in_treatment)]
#e2_mod_5 <- d[experiment_no==2, lm(bounding_box_score ~ in_treatment)]
...
```{r}
e6_mod_2 <- d[experiment_no %in% c(5,6), lm(bounding_box_score ~ factor(Reward)+in_treatment)]
e6_mod_3 <- d[experiment_no %in% c(3,4,5,6), lm(bounding_box_score ~ factor(Reward)+in_treatment)]
e6_mod_4 <- d[experiment_no %in% c(3,4,5,6), lm(bounding_box_score ~ (Reward == "$0.20")+in_treatment)]
...
e7_mod_3 <- d[experiment_no %in% c(3,4,7), lm(bounding_box_score ~ in_treatment+factor(mousetrackpad))]
e7_mod_4 <- d[experiment_no %in% c(3,4,7), lm(bounding_box_score ~ in_treatment+factor(Reward))]
e7_mod_5 <- d[experiment_no %in% c(3,4,7), lm(bounding_box_score ~ in_treatment+factor(mousetrackpad)+factor(Reward))]
